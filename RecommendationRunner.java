...
public class RecommendationRunner implements Recommender {
   ...
   public ArrayList<String> getItemsToRate () {
       ...
       ArrayList<String> totalMovies = MovieDatabase.filterBy(new TrueFilter());
       Random rand = new Random();
       for(int i=0;i<numDisplay;i++) {
          int result = rand.nextInt(totalMovies.size());
          String ID = totalMovies.get(result);
   ...
   public void printRecommendationsFor (String webRaterID) {
       MovieDatabase.initialize("ratedmoviesfull.csv");
        ...
        if (ratingList.size() == 0) {
            ...
            System.out.println("<h2>The engine Brings Best Movies for You! Enjoy!^^</h2>");
